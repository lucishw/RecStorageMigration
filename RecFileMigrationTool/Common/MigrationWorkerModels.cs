...
namespace Common
{
    public class MigrationPathMapping
    {
        public bool Enabled { get; set; }
        public string VirtualPath { get; set; }
        public string RealSourcePath { get; set; }
    ...
    {
        public MigrationWorkerSettings()
        {
            PathMappings = new List<MigrationPathMapping>();
        }
        ...
        public bool UseYearTableMarking { get; set; }
        ...
        public List<MigrationPathMapping> PathMappings { get; set; }
